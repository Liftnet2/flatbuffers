...
class Monster {
  ...
  List<Weapon>? get weapons => const fb.ListReader<Weapon>(Weapon.reader)
  ...
  List<Vec3>? get path => const fb.ListReader<Vec3>(Vec3.reader)
...
class MonsterObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? pathOffset =
        _path == null ? null : fbBuilder.writeListOfStructs(_path);
    fbBuilder.startTable(10);
    if (_pos != null) {
