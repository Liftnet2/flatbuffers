...
class Vec3 {
  ...
  Vec3T unpack() => Vec3T(
      x: x, y: y, z: z, test1: test1, test2: test2, test3: test3.unpack());
...
class Vec3Builder {
  ...
  int finish(double x, double y, double z, double test1, Color test2,
...
class Monster {
  ...
  List<Test>? get test4 => const fb.ListReader<Test>(Test.reader)
      .vTableGetNullable(_bc, _bcOffset, 22);
  List<String>? get testarrayofstring =>
      const fb.ListReader<String>(fb.StringReader())
          .vTableGetNullable(_bc, _bcOffset, 24);

  ///  an example documentation comment: this will end up in the generated code
  ///  multiline too
  List<Monster>? get testarrayoftables =>
      const fb.ListReader<Monster>(Monster.reader)
  ...
  List<bool>? get testarrayofbools => const fb.ListReader<bool>(fb.BoolReader())
  ...
  List<String>? get testarrayofstring2 =>
      const fb.ListReader<String>(fb.StringReader())
          .vTableGetNullable(_bc, _bcOffset, 60);
  List<Ability>? get testarrayofsortedstruct =>
      const fb.ListReader<Ability>(Ability.reader)
          .vTableGetNullable(_bc, _bcOffset, 62);
  List<int>? get flex =>
      const fb.Uint8ListReader().vTableGetNullable(_bc, _bcOffset, 64);
  List<Test>? get test5 => const fb.ListReader<Test>(Test.reader)
      .vTableGetNullable(_bc, _bcOffset, 66);
  List<int>? get vectorOfLongs => const fb.ListReader<int>(fb.Int64Reader())
      .vTableGetNullable(_bc, _bcOffset, 68);
  List<double>? get vectorOfDoubles =>
      const fb.ListReader<double>(fb.Float64Reader())
  ...
  List<Referrable>? get vectorOfReferrables =>
      const fb.ListReader<Referrable>(Referrable.reader)
          .vTableGetNullable(_bc, _bcOffset, 74);
  int get singleWeakReference =>
      const fb.Uint64Reader().vTableGet(_bc, _bcOffset, 76, 0);
  List<int>? get vectorOfWeakReferences =>
  ...
  List<int>? get vectorOfNonOwningReferences =>
      const fb.ListReader<int>(fb.Uint64Reader())
  ...
  dynamic get anyUnique {
    switch (anyUniqueType?.value) {
      ...
      case 2:
        return TestSimpleTableWithEnum.reader
            .vTableGetNullable(_bc, _bcOffset, 92);
      case 3:
        return my_game_example2.Monster.reader
            .vTableGetNullable(_bc, _bcOffset, 92);
      default:
  ...
  List<Color>? get vectorOfEnums => const fb.ListReader<Color>(Color.reader)
  ...
  List<Stat>? get scalarKeySortedTables =>
      const fb.ListReader<Stat>(Stat.reader)
  ...
  double get negativeInfDefault => const fb.Float32Reader()
      .vTableGet(_bc, _bcOffset, 122, double.negativeInfinity);
  double get negativeInfinityDefault => const fb.Float32Reader()
      .vTableGet(_bc, _bcOffset, 124, double.negativeInfinity);
  ...
  MonsterT unpack() => MonsterT(
      ...
      hp: hp,
      name: name,
      inventory: const fb.Uint8ListReader(lazy: false)
          .vTableGetNullable(_bc, _bcOffset, 14),
      color: color,
      testType: testType,
      test: test,
      test4: test4?.map((e) => e.unpack()).toList(),
      testarrayofstring: const fb.ListReader<String>(fb.StringReader(), lazy: false)
          .vTableGetNullable(_bc, _bcOffset, 24),
      testarrayoftables: testarrayoftables?.map((e) => e.unpack()).toList(),
      enemy: enemy?.unpack(),
      testnestedflatbuffer: const fb.Uint8ListReader(lazy: false)
      ...
      testarrayofbools: const fb.ListReader<bool>(fb.BoolReader(), lazy: false)
          .vTableGetNullable(_bc, _bcOffset, 52),
      testf: testf,
      testf2: testf2,
      testf3: testf3,
      ...
      flex: const fb.Uint8ListReader(lazy: false)
...
class MonsterT implements fb.Packable {
  ...
  int pack(fb.Builder fbBuilder) {
    ...
    final int? testarrayofstringOffset = testarrayofstring == null
        ? null
        : fbBuilder
            .writeList(testarrayofstring!.map(fbBuilder.writeString).toList());
    ...
    final int? testarrayofstring2Offset = testarrayofstring2 == null
        ? null
        : fbBuilder
            .writeList(testarrayofstring2!.map(fbBuilder.writeString).toList());
    int? testarrayofsortedstructOffset;
    if (testarrayofsortedstruct != null) {
      for (var e in testarrayofsortedstruct!) {
        e.pack(fbBuilder);
      }
      testarrayofsortedstructOffset =
          fbBuilder.endStructVector(testarrayofsortedstruct!.length);
    }
...
class MonsterObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? testarrayofstringOffset = _testarrayofstring == null
        ? null
        : fbBuilder
            .writeList(_testarrayofstring.map(fbBuilder.writeString).toList());
    final int? testarrayoftablesOffset = _testarrayoftables == null
        ? null
        : fbBuilder.writeList(_testarrayoftables
    ...
    final int? testarrayofstring2Offset = _testarrayofstring2 == null
        ? null
        : fbBuilder
            .writeList(_testarrayofstring2.map(fbBuilder.writeString).toList());
    ...
    final int? vectorOfReferrablesOffset = _vectorOfReferrables == null
        ? null
        : fbBuilder.writeList(_vectorOfReferrables
            .map((b) => b.getOrCreateOffset(fbBuilder))
            .toList());
    ...
    final int? vectorOfStrongReferrablesOffset =
        _vectorOfStrongReferrables == null
            ? null
            : fbBuilder.writeList(_vectorOfStrongReferrables
                .map((b) => b.getOrCreateOffset(fbBuilder))
                .toList());
    final int? vectorOfCoOwningReferencesOffset =
    ...
    final int? scalarKeySortedTablesOffset = _scalarKeySortedTables == null
        ? null
        : fbBuilder.writeList(_scalarKeySortedTables
            .map((b) => b.getOrCreateOffset(fbBuilder))
            .toList());
    fbBuilder.startTable(62);
    if (_pos != null) {
...
class TypeAliases {
  ...
  List<double>? get vf64 => const fb.ListReader<double>(fb.Float64Reader())
      .vTableGetNullable(_bc, _bcOffset, 26);
  ...
  TypeAliasesT unpack() => TypeAliasesT(
      ...
      f32: f32,
      f64: f64,
      v8: const fb.Int8ListReader(lazy: false)
          .vTableGetNullable(_bc, _bcOffset, 24),
      vf64: const fb.ListReader<double>(fb.Float64Reader(), lazy: false)
          .vTableGetNullable(_bc, _bcOffset, 26));
