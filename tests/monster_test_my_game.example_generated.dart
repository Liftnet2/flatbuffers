...
class MonsterT implements fb.Packable {
  ...
  int pack(fb.Builder fbBuilder) {
    ...
    final int? testarrayofstringOffset =
        testarrayofstring == null
            ? null
            : fbBuilder.writeList(
              testarrayofstring!.map(fbBuilder.writeString).toList(),
            );
    final int? testarrayoftablesOffset =
        testarrayoftables == null
            ? null
            : fbBuilder.writeList(
              testarrayoftables!.map((b) => b.pack(fbBuilder)).toList(),
            );
    final int? enemyOffset = enemy?.pack(fbBuilder);
    final int? testnestedflatbufferOffset =
        testnestedflatbuffer == null
            ? null
            : fbBuilder.writeListUint8(testnestedflatbuffer!);
    final int? testemptyOffset = testempty?.pack(fbBuilder);
    final int? testarrayofboolsOffset =
        testarrayofbools == null
            ? null
            : fbBuilder.writeListBool(testarrayofbools!);
    final int? testarrayofstring2Offset =
        testarrayofstring2 == null
            ? null
            : fbBuilder.writeList(
    ...
    final int? vectorOfDoublesOffset =
        vectorOfDoubles == null
            ? null
            : fbBuilder.writeListFloat64(vectorOfDoubles!);
    final int? parentNamespaceTestOffset = parentNamespaceTest?.pack(fbBuilder);
    final int? vectorOfReferrablesOffset =
        vectorOfReferrables == null
            ? null
            : fbBuilder.writeList(
              vectorOfReferrables!.map((b) => b.pack(fbBuilder)).toList(),
            );
    final int? vectorOfWeakReferencesOffset =
        vectorOfWeakReferences == null
            ? null
    ...
    final int? vectorOfEnumsOffset =
        vectorOfEnums == null
            ? null
            : fbBuilder.writeListUint8(
              vectorOfEnums!.map((f) => f.value).toList(),
            );
    ...
    final int? scalarKeySortedTablesOffset =
        scalarKeySortedTables == null
            ? null
            : fbBuilder.writeList(
